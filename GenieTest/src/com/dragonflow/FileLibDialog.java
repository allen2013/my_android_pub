				...
				if (doWhat == FILE_LIB_ADD) {
					...
					if (!fm.isMultFile()) {
						if (child.contains(path)) {
							Toast.makeText(fm, path + "�Ѵ���", Toast.LENGTH_SHORT).show();
							return false;
						}
						child.add(path);
					} else {
							...
							new AlertDialog.OnClickListener() {
								...
								public void onClick(DialogInterface dialog, int which) {
									...
									case 0:
										...
										b.setTitle("ɾ���ļ���").setMessage("ȷ��Ҫɾ�� " + libName + " ?")
									...
									case 1:
										...
										XDialog.inputDialog(fm, "" + libName, 
												"", libName, null, 
