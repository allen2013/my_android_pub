...
public class MyImageView extends ImageView {
	...
	private void arithScaleRate() {
		float scaleWidth = ImageDlnaShareActivity.linear.getWidth() / (float) imageWidth;
		float scaleHeight = ImageDlnaShareActivity.linear.getHeight() / (float) imageHeight;
	...
	public void setImageBitmap(Bitmap bitmap) {
		...
		arithScaleRate();
		//缩放到屏幕大小
		zoomTo(scaleRate,ImageDlnaShareActivity.linear.getWidth() / 2f, ImageDlnaShareActivity.linear.getHeight() / 2f);
...
//		RectF rect = new RectF(0, 0, imageWidth*getScale(), imageHeight*getScale());
	...
	public void layoutToCenter()
	{
		...
		//空白区域宽高
		float fill_width = ImageDlnaShareActivity.linear.getWidth() - width;
		float fill_height = ImageDlnaShareActivity.linear.getHeight() - height;
	...
	protected float getValue(Matrix matrix, int whichValue) {
		...
		mMinZoom =( ImageDlnaShareActivity.linear.getWidth()/2f)/imageWidth;
