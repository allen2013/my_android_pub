...
public class SpinnerButton extends Button {
	...
	class UMSpinnerButtonOnClickListener implements View.OnClickListener {
		...
		public void onClick(View v) {
			if(ImageDlnaShareActivity.autotime==5000){
				setColor();
				auto_5s.setBackgroundColor(Color.rgb(128, 128, 128));
			}else if(ImageDlnaShareActivity.autotime==10000){
				setColor();
				auto_10s.setBackgroundColor(Color.rgb(128, 128, 128));
			}else if(ImageDlnaShareActivity.autotime==15000){
				setColor();
				auto_15s.setBackgroundColor(Color.rgb(128, 128, 128));
			}
//			else if(ImageDlnaShareActivity.autotime==20000){
//				setColor();
//				auto_20s.setBackgroundColor(Color.rgb(210, 180, 140));
//			}else if(ImageDlnaShareActivity.autotime==25000){
//				setColor();
//				auto_25s.setBackgroundColor(Color.rgb(210, 180, 140));
//			}else if(ImageDlnaShareActivity.autotime==30000){
//				setColor();
//				auto_30s.setBackgroundColor(Color.rgb(210, 180, 140));
//			}
			else{
				setColor();
