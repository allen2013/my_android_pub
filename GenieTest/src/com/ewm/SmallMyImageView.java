...
public class SmallMyImageView extends ImageView {
	...
	public SmallMyImageView(Context context, int imageWidth, int imageHeight) {
		super(context);
	...
	public SmallMyImageView(Context context, AttributeSet attrs, int imageWidth, int imageHeight) {
		super(context, attrs);
		this.imageHeight = imageHeight;
		this.imageWidth = imageWidth;
		init();
	...
	private void arithScaleRate() {
		float scaleWidth = ImagesBrowseActivity.linear.getWidth() / (float) imageWidth;
		float scaleHeight = ImagesBrowseActivity.linear.getHeight() / (float) imageHeight;
...
//		RectF rect = new RectF(0, 0, imageWidth*getScale(), imageHeight*getScale());
	...
	public void layoutToCenter()
	{
		...
		//空白区域宽高
		float fill_width = ImagesBrowseActivity.linear.getWidth() - width;
		float fill_height = ImagesBrowseActivity.linear.getHeight() - height;
	...
	protected float getValue(Matrix matrix, int whichValue) {
		...
		mMinZoom =( ImagesBrowseActivity.linear.getWidth()/2f)/imageWidth;
