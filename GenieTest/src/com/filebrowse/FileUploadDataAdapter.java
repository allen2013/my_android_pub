...
public class FileUploadDataAdapter extends BaseAdapter {
	...
	public FileUploadDataAdapter(FileUploadActivity activity, List<File> list) {

		fileUploadActivity = activity;
		this.datalist = list;
	...
	public View getView(int position, View view, ViewGroup viewGroup) {
		...
		try {
				...
				if(filename.lastIndexOf(".")!=-1){
					...
					if(suffix!=null){
						...
						if("apk".equals(suffix)){
							Drawable apk_drawable=getAPKDrawable(file.getPath().toString(),fileUploadActivity);
			...
			if (fileUploadActivity.multFile && fileMutiList.contains(file.getAbsolutePath())) {
