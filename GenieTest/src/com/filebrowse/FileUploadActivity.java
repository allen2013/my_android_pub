...
//        .build());  
        ...
        System.out.println("dm-->"+dm.widthPixels+"-"+dm.heightPixels);
...
//        notification.flags|=Notification.FLAG_NO_CLEAR;
    	...
    	Intent notificationIntent = new Intent(this,FileUploadActivity.class); 
        ...
        filechooese=(Button) this.findViewById(R.id.chooesefile);
        final GridView filelist=(GridView) this.findViewById(R.id.fileList);
        listItemAdapter=new FileUploadDataAdapter(this, dataList);
...
//				}else{
//					chooeseflag=true;
//					filechooese.setBackgroundResource(R.drawable.grid_selector_background_pressed);
//					
//				}
    						...
    						if (multFile) {
    							...
    							if(isSingleFolder){
    								if(file.isDirectory()){
    									...
    									Toast.makeText(FileUploadActivity.this, "Select folder only!", Toast.LENGTH_SHORT).show();
    								}
    							}else{
    								if(file.isFile()){
    									...
    									Toast.makeText(FileUploadActivity.this, "Select file only!", Toast.LENGTH_SHORT).show();
    								}
    							}
    							listItemAdapter.setData(arrayListFileSelected);
    							listItemAdapter.notifyDataSetChanged();
	    	        			...
	    	        			if(file.isDirectory() && file.canRead()){
	    	        				try{
		    	        				SharedPreferences settings = FileUploadActivity.this.getSharedPreferences("DEFAULT_PATH", 0);
			            				if(null != settings)
			            				{
...
//        		}
        ...
        this.findViewById(R.id.filelist_back).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
//				findViewById(R.id.filelist_back).setBackgroundResource(R.drawable.title_bt_fj);
//				if(currentPath!=null){
//					EditText text=((EditText) findViewById(R.id.url));
//	        		text.setText(text.getText().toString().substring(0, text.getText().toString().lastIndexOf(currentPath.getName())));
//					loadFileList(currentPath.getParent());
...
//				}else{
		        	finish();
//				}
//				findViewById(R.id.filelist_back).setBackgroundResource(R.drawable.title_bt_bj);
        ...
        //上传文件
        fileupload=(Button) this.findViewById(R.id.fileupload);
        fileupload.setEnabled(false);
        fileupload.setTextColor(Color.GRAY);
        fileupload.setOnClickListener(new OnClickListener() {
			
			public void onClick(View v) {
				findViewById(R.id.fileupload).setBackgroundResource(R.drawable.title_bt_fj);
...
//			    		sendIntent.setClass(FileUploadActivity.this, Turbo_SendfileActivity.class);
...
//			    		startActivity(sendIntent);
					...
					new AlertDialog.Builder(FileUploadActivity.this).setTitle(R.string.error).setMessage(R.string.notselected_file_msg).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
...
//           		 listItemAdapter.notifyDataSetChanged();
		    		...
		    		runOnUiThread(new Runnable() {
						public void run() {
							new AlertDialog.Builder(FileUploadActivity.this).setTitle(R.string.error).setMessage(m_e.getMessage()).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
