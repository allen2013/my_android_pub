...
public class LocationFileListDataAdapter  extends BaseAdapter {

	private List<File> datalist=null;
	private LayoutInflater inflater=null;
	private int clickTemp=-1;
	private List<Integer> selectedPosition=new ArrayList<Integer>();
	private Context context;
	
	public LocationFileListDataAdapter(Context context,List<File> list) {
				...
				if(filename.lastIndexOf(".")!=-1){
					...
					if(suffix!=null){
						...
						if("apk".equals(suffix)){
							Drawable apk_drawable=getAPKDrawable(file.getPath().toString(),this.context);
...
//					selectedPosition.remove((Object)position);
//				}
//				clickTemp=-1;
			}else{
//				if(selectedPosition.contains(position)){
